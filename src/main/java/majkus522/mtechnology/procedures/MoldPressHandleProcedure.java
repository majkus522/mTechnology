...
public class MoldPressHandleProcedure 
{
	public static void execute(LevelAccessor world, double x, double y, double z) 
	{
		BlockPos position = new BlockPos(x, y, z);
		List<Recipe> recipes = MoldPressData.getRecipes();
		MachineModifire modifire = MoldPressData.getModifire(ExtensionMethods.getCountFromBlock(world, position, 3), ExtensionMethods.getCountFromBlock(world, position, 4));
