...
package majkus522.mtechnology.world.features.ores;
...
public class LeadOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("mtechnology:lead_ore", FEATURE,
				new OreConfiguration(LeadOreFeatureRuleTest.INSTANCE, MtechnologyModBlocks.LEAD_ORE.get().defaultBlockState(), 16));
		PLACED_FEATURE = PlacementUtils.register("mtechnology:lead_ore", CONFIGURED_FEATURE,
	...
	private static class LeadOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("mtechnology:lead_ore_match"), CUSTOM_MATCH);
		}
