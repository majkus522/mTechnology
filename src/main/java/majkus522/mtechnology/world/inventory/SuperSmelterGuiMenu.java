...
public class SuperSmelterGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SuperSmelterGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MtechnologyModMenus.SUPER_SMELTER_GUI, id);
